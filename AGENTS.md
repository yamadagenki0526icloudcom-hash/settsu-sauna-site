...
- クラウドファンディングは**2026年7月31日〜10月15日**（目標1,000万円、実行者=花岡工務店 花岡雅仁）。ページ: https://camp-fire.jp/projects/959370/view
...
5. **公開状態（2026-07-30〜）**: トップ`index.html`は`noindex`を解除し一般公開済み。`shop/`はデモのため`noindex`＋`robots.txt`でDisallow継続。トップの`noindex`を戻す／商店を公開する判断はげんきさんに確認する
...
- `shop/`トップバーの「8.1開始」表記が旧日付のまま（正: 7月31日〜10月15日）。商店を公開する場合は要修正
